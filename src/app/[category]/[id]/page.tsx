...
export default function ByLocationId() {
  return (
  <>
    <Head>
        ...
        <div className='outer-container'>
          <h1 className='text-2xl font-bold'>Best Car Boot Sales in London</h1>
          <p className='text-gray-600'>Discover top-rated car boot sales in London. View listings, schedules, and visitor ratings.</p>
