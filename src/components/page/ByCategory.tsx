...
export default function ByCategory({ category }: ByLocationIdProps) {
    ...
    return (
        <main className=" my-[1em]">
            ...
            <BreadCrumbs navs={[{ name: 'Home', href: '/' }, { name: ucWords(category), href: `/categories/${category}` }]}/>


            <div className='outer-container'>
                <h1 className='text-2xl font-bold capitalize'>{ucWords(category)}</h1>
                <p className='text-gray-600'>Discover top-rated {category} across the UK. View listings, schedules, and visitor ratings.</p>
